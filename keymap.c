...
[_BASE] = LAYOUT_planck_grid(
	...
	KC_NO, KC_LCTL, KC_LALT, C(KC_A), LOWER, SPECIAL, KC_SPC, RAISE, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
),
[_LOWER] = LAYOUT_planck_grid(
	...
	KC_NO, KC_LCTL, KC_LALT, C(KC_A), KC_NO, KC_NO, KC_SPC, UPPER, KC_0, KC_NO, KC_NO, KC_NO
),
[_RAISE] = LAYOUT_planck_grid(
	...
	KC_NO, KC_LCTL, KC_LALT, C(KC_A), UPPER, KC_NO, KC_SPC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
),
